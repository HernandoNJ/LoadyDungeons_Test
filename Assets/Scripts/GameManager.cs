...
public class GameManager : MonoBehaviour
{
	...
	public void OnEnable()
	{
		...
		if (!m_LogoAssetReference.RuntimeKeyIsValid()) return;
	...
	private void OnLogoLoadComplete(AsyncOperationHandle<Sprite> asyncOpHandleParam)
	{
		if (asyncOpHandleParam.Status == AsyncOperationStatus.Succeeded)
		{
			m_gameLogoImage.sprite = asyncOpHandleParam.Result;
		}
	}
